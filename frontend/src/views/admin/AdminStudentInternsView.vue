          ...
          <table class="interns-table" v-if="filteredInterns.length">
            ...
            <tbody>
              <tr v-for="(intern, index) in filteredInterns" :key="intern.id">
                ...
                <td>{{ intern.tagging || 'Normal Hours' }}</td>
                <td>
          ...
          <div class="modal">
            ...
            <form @submit.prevent="handleAddIntern" class="modal-form">
              <div class="modal-grid">
                ...
                <div class="form-group">
                  <label>Tagging</label>
                  <select v-model="newIntern.tagging">
                    ...
                    <option value="Early In and Early Out">Early In and Early Out</option>
                  </select>
                </div>
              </div>
          ...
          <div class="modal">
            ...
            <form @submit.prevent="handleUpdateIntern" class="modal-form">
              <div class="modal-grid">
                ...
                <div class="form-group">
                  <label>Tagging</label>
                  <select v-model="selectedIntern.tagging" :disabled="viewEditMode === 'view'">
                    <option value="Normal Hours">Normal Hours</option>
                    <option value="Overtime">Overtime</option>
                    <option value="Early In">Early In</option>
                    <option value="Early Out">Early Out</option>
    ...
    async handleAddIntern() {
      ...
      try {
        const payload = {
          ...
          tagging: this.newIntern.tagging || 'Normal Hours',
          role: 'student',
          position: 'intern',
        }
    ...
    async handleUpdateIntern() {
      ...
      try {
        ...
        const payload = {
          ...
          tagging: this.selectedIntern.tagging || '',
        }
